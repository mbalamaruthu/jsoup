...
public interface Connection {
	...
	/**
	 * Set the request user-agent listener for all internal redirects
	 * 
	 * @param Listener
	 *            to get userAgent
	 * @return this Connection, for chaining
	...
	public interface Request extends Base<Request> {
		...
		/**
		 * Set User Agent Listener for request header
		 * 
		 * @param userAgentListener
		 */
		public void setUserAgentListener(RedirectUserAgentListener userAgentListener);

		/**
		 * Set user agent from the listener
		 * 
		 * @param url
		 */
